...
export default function Patch({ onClose }) {
  ...
  return (
    <Draggable handle=".patch-titlebar" bounds="parent" defaultPosition={{ x: 80, y: 90 }}>
      <div className="patch-window">
        <div className="patch-titlebar">
          <div className="patch-barname">
            <span>Patch</span>
          </div>
          <div className="patch-barbtn">
            <button type="button" className="patch-btn" onClick={onClose}>×</button>
          </div>
        </div>
